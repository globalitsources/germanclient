import {GoogleAnalyticsV4} from "~/service/helpers/strings";
...
export const initializeGoogleAnalytics = () => {
  ...
  //
  // gaScript.setAttribute("data-cookie", '');
  // gaScript.setAttribute("data-category", "analytics");
  //
  // document.head.appendChild(gaScript);
  //
  // ga('create', GoogleAnalyticsV4, 'auto');
  // ga('send', 'pageview');
...
/*
  (function(i,s,o,g,r,a,m){
      ...
      a.async=1;
      a.src=g;
      a.setAttribute("data-cookie", '');
      a.setAttribute("data-category", "analytics");
...
*/
    ...
    scrpt.src = "https://www.googletagmanager.com/gtag/js?id=G-SXV19HTE5M";
    scrpt.async = true;
    scrpt.type = "text/plain";
 ...
 const _paq = window._paq = window._paq || [];
    ...
    (function() {
        const u = "//admin.zimmer-im-revier.de/";
        _paq.push(['setTrackerUrl', u+'matomo.php']);
        _paq.push(['setSiteId', '1']);
        const d = document, g = d.createElement('script'), s = d.getElementsByTagName('script')[0];
        g.async=true; g.src=u+'matomo.js';
        g.setAttribute("data-cookie", '');
        g.setAttribute("data-category", "analytics");
...
//       textDisableSuccess:
//         "Optout für diese Seite erfolgreich gesetzt. Google Analytics erfasst in diesem Browser keine Statistiken mehr zu dieser Webseite.",
//       debug: false,
//     },
//     clientId = false,
//     windowId = false,
...
//       if (settings.debug) {
//         console.log(
//           "SGGoogleAnalytics.trackVersion: %i",
//           settings.trackingVersion
//         );
//       }
...
//           if (settings.debug) {
//             console.log(
//               "SGGoogleAnalytics.trackIndividualHits: hitType: %s",
//               hitType
//             );
//           }
...
//         console.log(
//           "SGGoogleAnalytics.trackIndividualHits: hitTime: %s",
//           hitTime
//         );
//       }
//     }
...
//     if (settings.debug) {
//       console.log(
//         "SGGoogleAnalytics.trackError: Script, error, %s, uncaught error",
//         (error && error.stack) || "(not set)"
//       );
//     }
//   };
//
...
//       pagePerformance.domContentLoaded = Math.round(
//         nt.domContentLoadedEventStart - navStart
//       );
//       pagePerformance.pageLoaded = Math.round(nt.loadEventStart - navStart);
//
//       // check if all metric values are somehow valid
//       if (
//         isIntegerValueValid(pagePerformance.serverResponseEnd) &&
...
//         };
//         // add metric values
//         fieldObj[settings.metricServerResponseEnd] =
//           pagePerformance.serverResponseEnd;
//         fieldObj[settings.metricDOMContentLoaded] =
//           pagePerformance.domContentLoaded;
//         fieldObj[settings.metricPageLoaded] = pagePerformance.pageLoaded;
//         // send event
//         ga("send", "event", fieldObj);
//         if (settings.debug) {
//           console.log(
//             "SGGoogleAnalytics.trackPerformance: Navigation Timing, track, %o",
//             pagePerformance
//           );
//         }
//       }
...
//           }
//           trackDownloadsSelector =
//             trackDownloadsSelector +
//             'a[href$=".' +
//             settings.eventDownloadsFileTypes[i] +
//             '"]';
//         }
//       }
...
//             "send",
//             "event",
//             settings.eventDownloadsCategory,
//             extension,
//             urlNoDomain,
//             {
//               transport: "beacon",
...
//             "send",
//             "event",
//             settings.eventOutboundCategory,
//             settings.eventOutboundAction,
//             urlNoProtocol,
//             {
//               transport: "beacon",
//               hitCallback: function () {
...
//       }
//
//       $sgEstateSearchBoxTrigger = $(
//         settings.sgEstateSearchBoxEventTriggerSelector
//       );
...
//             if (settings.debug) {
//               console.log(
//                 "SGGoogleAnalytics.trackSGEstateSearchBoxSend: SGEstate:sent:SearchBoxSent, %o",
//                 fieldObj
//               );
//             }
//           } else {
//             if (settings.debug) {
//               console.warning(
//                 "SGGoogleAnalytics.trackSGEstateSearchBoxSend: SGEstate:sent:SearchBoxSent, event not sent %o",
//                 fieldObj
//               );
//             }
//           }
...
//     }
//     // let disable = true;
//     let disableIdentifier = getAnalyticsDisableCookieIdentifier();
//     document.cookie =
//       disableIdentifier +
...
//         if (settings.debug) {
//           console.log(
//             "SGGoogleAnalytics.init: property: %s",
//             settings.property
//           );
//         }
